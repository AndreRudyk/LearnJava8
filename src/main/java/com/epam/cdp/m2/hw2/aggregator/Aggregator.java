...
public interface Aggregator {
   ...
   * @return words along with their frequencies (the output is sorted by frequency in descending
   * order, if frequencies are equal then sorted by words in alphabetical order)
   */
   ...
   * @param words list of words
   * @param limit use this parameter to control the number of elements to return
   * @return list with the words that have duplicates in the upper case sorted by length in
   * ascending order, if length is the same, sorted alphabetically
   */
